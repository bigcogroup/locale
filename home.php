                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                <div class="image">
                                    <img src="<?php echo $rows["product_image"]; ?>" class="card-img-top" alt="Product Image">
                                    <div class="card-body">
                                    <p class="card-text">
                                ...
                                <button class="btn btn-primary add" data-id="<?php echo $rows["product_id"]; ?>">Add to cart</button>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
